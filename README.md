...
> where the open frontier moved: **[docs/XDNA2.md](docs/XDNA2.md)**.
...
real ML `programming_examples`. Verified on **both generations** (`npu1` Phoenix
and `npu2` Strix — auto-detected). Setup reuses iree-amd-aie's Peano only when
